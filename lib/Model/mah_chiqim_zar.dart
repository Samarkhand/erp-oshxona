...
class MahChiqimZar  {
  ...
  static Set<MahChiqimZar> obyektlar = {};
  static MahChiqimZarService? service;
  ...
  @override
  operator == (other) => other is MahChiqimZar && other.trHujjat == trHujjat && other.tr == tr;

  @override
  int get hashCode => trHujjat.hashCode ^ tr.hashCode;
}

class MahChiqimZarService extends MahChiqimService {
  @override
  final String tableName = "mah_chiqim_zar";

  MahChiqimZarService({super.prefix = ''});
