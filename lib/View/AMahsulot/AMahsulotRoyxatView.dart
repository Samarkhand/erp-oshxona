...
import 'package:erp_oshxona/View/AMahsulot/AMahsulotRoyxatCont.dart';
...
class AMahsulotRoyxatView extends StatefulWidget {
  const AMahsulotRoyxatView({Key? key}) : super(key: key);

  @override
  State<AMahsulotRoyxatView> createState() => _AMahsulotRoyxatViewState();
}

class _AMahsulotRoyxatViewState extends State<AMahsulotRoyxatView> {
  final AMahsulotRoyxatCont _cont = AMahsulotRoyxatCont();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _appBar(context, title: "Mahsulot aylanmasi"),
      body: SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            await _dialogYangiAMahsulot(context);
          }),
    );
  }
  ...
  _dialogYangiAMahsulot(BuildContext context) {
    ...
    return showDialog(
        ...
        builder: (context) {
          List<Widget> list = [];
          for (var element in AMahsulotTur.obyektlar.values.toList()) {
            list.add(ListTile(
              leading: Icon(
                element.icon,
              ...
              onTap: () async {
                ...
                await Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          AMahsulotIchiView.yangi(element.tr)),
                );
