...
import 'package:erp_oshxona/View/AOrder/AOrderIchiCont.dart';
...
class AOrderIchiView extends StatefulWidget {
  AOrderIchiView(this.object, {Key? key})
      : yangimi = false,
        infomi = true,
        turi = 0,
        tr = 0,
  ...
  AOrderIchiView.tahrir(this.object, {Key? key})
      : yangimi = false,
        infomi = false,
        turi = 0,
        tr = 0,
  ...
  AOrderIchiView.yangi(this.turi, {Key? key})
      : yangimi = true,
        infomi = false,
        tr = 0,
        super(key: key);
  ...
  @override
  State<AOrderIchiView> createState() => _AOrderIchiViewState();
}

class _AOrderIchiViewState extends State<AOrderIchiView> {
  final AOrderIchiCont _cont = AOrderIchiCont();
  ...
  AppBar? _appBar(BuildContext context, {String? title}) {
    return AppBar(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute<void>(
                builder: (BuildContext context) {
                  return const QollanmaView(sahifa: 'xizmat');
                },
              ));
            },
          ),
        ...
        title: Text((_cont.isLoading)
            ...
            : title ??
                (widget.yangimi
                    ? "Yangi qayd: ${AOrderTur.obyektlar[_cont.object.turi]!.nomi}"
                    : (widget.infomi)
                        ? AOrderTur.obyektlar[widget.turi]!.nomi
                        ...
                        var tr = await Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => ABolimIchiView.yangi(
                              widget.turi == AOrderTur.menga.tr
                                  ? ABolimTur.chiqim.tr
                                  : ABolimTur.tushum.tr,
                              tanlansin: true,
                            ),
                              ...
                              child: Container(
                                ...
                                child: Row(children: [
                                  ...
                                  SizedBox(
                                    width: 100,
                                    child:
                                        _cont.object.turi == AOrderTur.menga.tr
                                            ? const Text(
                                                " Xizmat uchun to'lov qildim",
                                                style: TextStyle(fontSize: 13),
                                              )
                                            : const Text(
                                                " Xizmat uchun to'lov oldim",
                                                style: TextStyle(fontSize: 13),
                                              ),
                                  ),
                                ]),
  ...
  Widget _info(context) {
    final turi = AOrderTur.obyektlar[_cont.object.turi]!;
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      _cont.object.turi == AOrderTur.menga.tr
                          ? Text(" Xizmat uchun to'lov qildim",
                              style: MyTheme.h5)
                          : Text(" Xizmat uchun to'lov oldim",
                              style: MyTheme.h5),
                      IconButton(
