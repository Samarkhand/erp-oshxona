...
import 'package:erp_oshxona/View/AOrder/AOrderRoyxatCont.dart';
...
class AOrderRoyxatView extends StatefulWidget {
  const AOrderRoyxatView({Key? key}) : super(key: key);

  @override
  State<AOrderRoyxatView> createState() => _AOrderRoyxatViewState();
}

class _AOrderRoyxatViewState extends State<AOrderRoyxatView> {
  final AOrderRoyxatCont _cont = AOrderRoyxatCont();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _appBar(context, title: "Ko'rsatilgan xizmatlar"),
      body: SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            await _dialogYangiAOrder(context);
          }),
    );
  }
  ...
  _dialogYangiAOrder(BuildContext context) {
    ...
    return showDialog(
        ...
        builder: (context) {
          List<Widget> list = [];
          for (var element in AOrderTur.obyektlar.values.toList()) {
            list.add(ListTile(
              leading: Icon(
                element.icon,
              ...
              onTap: () async {
                ...
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AOrderIchiView.yangi(element.tr)),
                );
  ...
  turiTanlash(BuildContext context, StateSetter setState) {
    SelectDialog.showModal<AOrderTur>(
      context,
      label: "Amaliyot turini tanlang",
      searchBoxDecoration: const InputDecoration(hintText: "Izlash"),
      selectedValue: AOrderTur.obyektlar[turi],
      items: AOrderTur.obyektlar.values.toList(),
      onChange: (selected) {
