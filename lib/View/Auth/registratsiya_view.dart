                  ...
                  child: Column(
                    children: [
                      ...
                      CheckboxListTile(
                          ...
                          onChanged: (value) => setState(() => {_cont.ofertaTasdiq = !_cont.ofertaTasdiq},),
                          title: const Text(
                              "Ommaviy oferta shartlari bilan tanishdim va rozilik bildiraman")),
                      InkWell(
                        child: Container(alignment: Alignment.topLeft, padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 2), child: const Text("Ommaviy oferta bilan tanishish", style: TextStyle(color: Colors.blue, decoration: TextDecoration.underline),),),
                        onTap: () async {
